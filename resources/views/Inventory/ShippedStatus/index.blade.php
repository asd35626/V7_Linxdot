                                ...
                                <div class="uk-width-10-10">
                                    ...
                                    <div class="uk-grid">
                                        <div class="uk-width-1-3">
                                            {!! $searchFields['WarehouseID']['completeField'] !!}
                                        </div>
                                        <div class="uk-width-1-3">
                                            {!! $searchFields['SkuID']['completeField'] !!}
                                        </div>
                                        <div class="uk-width-1-3">
                                            {!! $searchFields['PalletID']['completeField'] !!}
                                        </div>
                                    </div>
                                    <div class="uk-grid">
                                        <div class="uk-width-1-3">
                                            {!! $searchFields['CatronID']['completeField'] !!}
                                        </div>
                                        <div class="uk-width-1-3">
                                    ...
                                    <div class="uk-grid">
                                        <div class="uk-width-1-3">
                                            {!! $searchFields['Location']['completeField'] !!}
                                        </div>
                                        <div class="uk-width-1-3">
                                    ...
                                    <div class="uk-grid">
                                        <div class="uk-width-1-3">
                                            {!! $searchFields['ShippedDateFrom']['completeField'] !!}
                                        </div>
                                        <div class="uk-width-1-3">
                                            {!! $searchFields['ShippedDateTo']['completeField'] !!}
                                        </div>
                                    </div>
                                    <!-- uk-grid end -->
                                </div>
                    ...
                    @if($data->count() > 0)
                        @foreach ($data as $object)
                            <tr>
                                ...
                                <td class="uk-text-small">{{ $object->Location }}</td>
                                <td class="uk-text-small">
                                    @if($object->IfShipped == 1)
                                        Y
                                    @else
                                        N
                                    @endif
