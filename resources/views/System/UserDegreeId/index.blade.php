                ...
                <table id="grid-basic" class="uk-table uk-table-nowrap table_check">
                    <thead>
                        <tr>
                            ...
                            <th class="uk-width-1-10 uk-text-small">編碼(用於特定功能)</th>
                    ...
                    @if($data->count() > 0)
                        ...
                        <tr>
                            ...
                            <td class="uk-text-small">{{ $object->Code }}</td>
                            <td class="uk-text-small">{{ $object->DegreeMemo }}</td>
                            ...
                            <td class="uk-text-center uk-text-small">
                                ...
                                {!! Form::open(['id' => 'formDeleteAction'.$i , 'method' => 'DELETE','route' => [ $routePath.'.destroy', $object->toArray()[$primaryKey]],'style'=>'display:inline']  ) !!}
                                    <a href="javascript:if(confirm('確定要刪除這筆資料嗎？'))$('{{ '#formDeleteAction'.$i }}').submit();">
