...
<script type="text/javascript">
    $(document).ready(function(){
        $("label[for='ParentFunctionId']").addClass( "stream_title" );
    });
</script>
@endsection
                            ...
                            <div class="uk-grid uk-grid-medium form_section" data-uk-grid-match="">
                                <div class="uk-width-10-10">
                                    ...
                                    <div class="uk-grid">
                                        ...
                                        <div class="uk-width-1-3">
                                           {!! $searchFields['ParentFunctionId']['completeField'] !!}
                                        </div>
                                    </div>
                                    <!-- uk-grid end -->
                                </div>
                ...
                <table id="grid-basic" class="uk-table uk-table-nowrap table_check">
                    <thead>
                        <tr>
                            ...
                            <th class="uk-width-1-10 uk-text-small">主選單</th>
                            <th class="uk-width-1-10 uk-text-small">子選單排序</th>
                            <th class="uk-width-1-10 uk-text-small">名稱</th>
                            <th class="uk-width-1-10 uk-text-small">功能代號</th>
                    ...
                    @if($data->count() > 0)
                        @foreach ($data as $object)
                            <tr>
                                ...
                                <td class="uk-text-small">{{ $object->arentFunctionName}}</td>
                                <td class="uk-text-small">{{ $object->MenuOrder}}</td>
                                <td class="uk-text-small">{{ $object->FunctionName }}</td>
                                <td class="uk-text-small">{{ $object->FunctionCode }}</td>
