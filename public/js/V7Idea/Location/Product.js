  var ajaxTable;
  var THISURLADD = "/Location/ProductAdd";
  var THISURLEDIT = "/Location/ProductEdit/";

  var THISAPI = "/api/v1/LocationProduct";
  ...
  function listAjaxTable() {
    var table = $('#grid-basic').DataTable({
      ...
      "ajax": {
        ...
        "data": function(d) {
          d.action = "list";
          d.searchProductName = $('#list #ProductName').val();
          d.searchProductCode = $('#list #ProductCode').val();
        }
      },
      "columns": [{
        "data": "BrandCode",
