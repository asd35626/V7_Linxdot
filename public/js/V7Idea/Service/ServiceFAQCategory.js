...
$(document).ready(function() {
  ...
  if (id == undefined) {
    ...
    webDocumentCategoryTable = listWebDocumentCategoryTable();
...
//get listWebDocumentCategoryTable table
function listWebDocumentCategoryTable() {
...
//do list search
function search() {
  webDocumentCategoryTable.ajax.reload();
}
...
function editData(thisId) {
  ...
  //get detail data
  $.ajax({
    url: "/api/v1/WebDocumentCategory/" + thisId,
    type: 'GET',
    headers: {
    ...
    success: function(response) {
      if (response.status == 1) {
        ...
        $('#editCategoryTitle').val(response.data.CategoryTitle);
        $('#editCategoryDescription').val(response.data.CategoryDescription);
...
function sendEditData() {
  ...
  $.ajax({
    url: "/api/v1/WebDocumentCategory/" + $('#editId').val(),
    type: 'PUT',
    data: formData,
    async: false,
    headers: {
