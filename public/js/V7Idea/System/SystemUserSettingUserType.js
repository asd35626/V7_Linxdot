...
function listUserTypes() {
  var table = $('#grid-basic').DataTable({
    ...
    "ajax": {
      ...
      "data": function(d) {
        d.action = "list";
        d.userTypeId = $('#userTypeId').val();
        d.userTypeName = $('#userTypeName').val();
        d.userTypeMemo = $('#userTypeMemo').val();
      }
    },
    "columns": [{
      "data": "UserTypeId"
  ...
  $.ajax({
    ...
    success: function(response) {
      if (response.status == 1) {
        ...
        $('#editUserTypeName').val(response.data.UserTypeName);
        $('#editUserTypeMemo').val(response.data.UserTypeMemo);
