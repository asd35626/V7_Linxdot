...
function toAdd() {
  ...
  if (id == '') {
    window.location = "/Banner/CategoryAdd";
  } else {
    window.location = "/Banner/CategoryAdd/" + id;
  }
}
...
function editData(thisId) {
  ...
  window.location = "/Banner/CategoryEdit/" + thisId;
}
...
function reload(thisId) {
  ...
  window.location = "/Banner/Category/" + thisId;
