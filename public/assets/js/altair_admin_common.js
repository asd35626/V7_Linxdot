...
// 3. Common functions & variables
    ...
    altair_main_sidebar = {
        init: function() {
            ...
            console.log('altair_main_sidebar.init()');
            ...
            if($sidebar_main.length) {
                ...
                if ($body.hasClass('sidebar_mini')) {
                    ...
                    $document.on('click keyup', function(e) {
                        ...
                        console.log('sidebar_main_toggle is clicked!click keyup');

                        if( $body.hasClass('sidebar_main_active') && $window.width() < 1220 ) {
                            
                             console.log('sidebar_main_active $window.width() < 1220');
                            if (
