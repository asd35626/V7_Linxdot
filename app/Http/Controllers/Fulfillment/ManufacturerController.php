...
/**
 *  這是用在管理製造商資料Controller, 將對應的幾個不用的View
 */
class ManufacturerController extends Controller
{
    ...
    function __construct(){
        WebLib::checkUserPermission('Manufacturer');
    }
    // 設定blade目錄的位置
    public static $viewPath = "Fulfillment.Manufacturer";
    
    // 設定route目錄的位置
    public static $routePath = "Manufacturer";
    ...
    // 設定功能名稱
    public static $functionname = "Manufacturer";

    // 設定功能名稱
    public static $functionURL = "/Fulfillment/Manufacturer";
    ...
    */
    public function store(Request $request)
    {
        ...
        if($requestResult['isError'] == false) {
            ...
            $formFields['CreateDate']['completeField'] = GenerateData::generateData('Created Date','CreateDate', 'CreateBy', '', 'text');
